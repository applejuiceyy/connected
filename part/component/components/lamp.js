...
class SegmentDisplay extends ComponentBuilder {
  constructor(name) {
    super(name);
    this.arr = [0b0111111, 0b0100001, 0b1011011, 0b1110011, 0b1100101, 0b1110110, 0b1111110, 0b0100011, 0b1111111, 0b1110111, 0b1101111, 0b1111100, 0b0011110, 0b0111111, 0b1011110, 0b1001110];
  }
  ...
  evaluate(component) {
    let idx = component.interactors.A.state << 3 | component.interactors.B.state << 2 | component.interactors.C.state << 1 | component.interactors.D.state;
