...
function setup(app, container) {
  ...
  container.renderComponentAt = function (component, x, y, maybe_hide) {
    ...
    let mouse_over = component.x <= pos.x && component.x + rotatedSize.x > pos.x && component.y <= pos.y && component.y + rotatedSize.y > pos.y;
    ...
    if (component.image !== null) {
      let pos = {
        x: rotatedSize.x / 2 * app.tilesize + screen.x,
        y: rotatedSize.y / 2 * app.tilesize + screen.y
      };
