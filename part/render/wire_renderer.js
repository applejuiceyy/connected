          ...
          if (system !== null) {
            ...
            for (let outline = 0; outline < 2; outline++) {
              ...
              drawConnection(layer, Side.UP, {
                x: app.pan.x + (x + centre) * app.tilesize,
                y: app.pan.y + (y + centre) * app.tilesize
              }, {
                x: app.pan.x + (x + centre) * app.tilesize,
                y: app.pan.y + y * app.tilesize
              });
              drawConnection(layer, Side.DOWN, {
                ...
                x: app.pan.x + (x + centre) * app.tilesize,
                y: app.pan.y + (y + 1) * app.tilesize
              });
              drawConnection(layer, Side.LEFT, {
                x: app.pan.x + (x + centre) * app.tilesize,
                y: app.pan.y + (y + centre) * app.tilesize
              }, {
                x: app.pan.x + x * app.tilesize,
                y: app.pan.y + (y + centre) * app.tilesize
              });
